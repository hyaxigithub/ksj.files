...
namespace Com.KSJ.Common
{
    public class MD5
    {
        ...
        /// <summary>
        /// is32Length=true 32位，false 16位
        /// </summary>
        /// <param name="sMessage"></param>
        /// <param name="is32Length"></param>
        /// <returns></returns>
        public static string Encrypt(string sMessage, bool is32Length)
        {
            string strMD5 = "";
            ...
            if (is32Length)
            {
                strMD5 = ((((WordToHex(a)) + (WordToHex(b))) + (WordToHex(c))) + (WordToHex(d))).ToLower();
            }
            else
            {
                strMD5 = ((WordToHex(b)) + (WordToHex(c))).ToLower();
            }
            return strMD5;
        }
    }
