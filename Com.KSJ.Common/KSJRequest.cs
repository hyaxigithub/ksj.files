	...
	public class KSJRequest
	{
        ...
        public static string GetClientName()
        {
            ...
            if(!string.IsNullOrEmpty(clientIP))
            {
                ...
                clientName = hostEntry.HostName;//获取客户端计算机名称
            }
        ...
        /// <summary>
        /// 获取完整的URL根路径，如：http://192.168.1.1:9010
        /// </summary>
        /// <returns></returns>
        public static string GetCurrentRootUrl()
        {
            HttpRequest request = System.Web.HttpContext.Current.Request;
            string temp = string.Format("{0}://{1}", request.Url.Scheme, request.Url.Host);
            if (!request.Url.IsDefaultPort)
                return string.Format("{0}:{1}", temp, request.Url.Port.ToString());
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !KSJUtility.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
		...
		{
            return KSJUtility.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
		}
        ...
        {
            return KSJUtility.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
		...
		{
            return KSJUtility.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
		}
